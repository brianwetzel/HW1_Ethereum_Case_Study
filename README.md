...
![Ethereum_Logo](hw1_images/ethereumlogo.jpg)
...
Here you can see options to explore the dApps available on Ethereum. [Ethereum.org]
<br><br>

<b>Finance</b> - Decentralized Finance, or DeFi, is a new type of secure and decentralized banking system built on Ethereum.  This allows users to participate in all types of banking transactions without a centralized single point of failure.  Users can make payments, borrow and lend, earn yield, issue unique digital assets, track real world assets, and more.  Potential users include people interested in: banking alternatives, sending money internationally 24/7, banking without KYC, seeking high yield on their assets, etc.  DeFi has a Total Value Locked of $177B space, where Ethereum makes up $124B of that, or 70%.  [DeFi Llama, Sept 2021]  
<br><br>

<b>Art, Collectibles, & Gaming</b> - Non-Fungible Tokens, or NFTs, are assets on the blockchain that are unique from one another.  They can include digital assets (ie. art, music, images) or a digital representation of real world assets (ie. deeds for real estate, copyrights, stocks, identity management).  The decentralized nature of this platform also allows for intermediaries to be removed and thus creating new markets for creators and audiences to sell directly and simplify transactions.  Communities have a natural tendency to form around NFTs as like minded people are connected directly.  Potential users include: artists, musicians, collectors, sports fans, etc.  Nasdaq.com estimated NFTs to be a $370B market [nasdaq.com].
<br><br>

<b>Technology</b> - According to Ethereum.org “these are applications that focus on decentralizing developer tools, incorporating cryptoeconomic systems into existing technology, and creating marketplaces for open-source development work.”  So the potential user here is primarily developers.  According to a report published by dappros.com in 2018 there were approx 20,587 jobs worldwide specifically for coding just on Ethereum.  This number has surely grown a lot since then.
<br><br>
...
This chart gives shows users over time in the various categories of Ethereum dApps. [VanEck]
<br><br>
...
<b>DeFi </b>- DeFi is evolving from an experiment to a real world tool with many use cases.  We saw an explosion in DeFi 2021.  A common metric for measuring the activity and validity of a platform in the DeFi space is its Total Value Locked or TVL.  According to Medium.com “TVL represents the total amount of assets locked in the various DeFi applications smart contracts.”  Looking at the charts on DeFiLlama.com, we can see that $21B TVL in DeFi at the beginning of 2021 vs $174B today (Sept, 2021).
...
This graph tells the same story that Ethereum is much more expensive compared to its closest competitors.
...
A very cool website called txstreet.com visually displays the transaction taking place on the blockchain.  The website is a scene at a bus stop where it likens the transaction to people, and the blocks busses leaving the station.  We can see Ethereum has more than 75,000 transactions pending and an average fee of $8.03, while Bitcoin has 3,597 transactions pending and an average fee of $0.47. (Sept 30, 2021).
